      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-16">
          ...
          <Link
            ...
            target="_blank" 
            className="inline-flex items-center justify-center px-6 py-3 mt-6 border border-gray-300 shadow-sm text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors"
          >
            Ask About Your Specific Integration Needs
          </Link>
        </div>
      </div>
    </div>
